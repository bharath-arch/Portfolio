        ...
        <div className="md:flex">
            ...
            <div className="">
              ...
              <div className="md:flex flex-col mt-24 ml-20 hidden">
                <a
                    ...
                    onClick={(e) => handleClick(e, "About", aboutRef.current.offsetTop)}
                >
                  About
                </a>
                <a
                ...
                <a
                    ...
                    onClick={(e) => handleClick(e, "Projects", projectsRef.current.offsetTop)}
                >
                  Projects
                </a>
              </div>
          ...
          >
            <div className="flex-1 overflow-y-auto ">
              ...
              <div className={`md:mt-28 overflow-y-hidden md:flex flex-col mb-20 hidden`}>
                <p style={{opacity: 0.5}}>
                  {" "}
