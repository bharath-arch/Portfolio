      ...
      async function run() {
        const chatSession = model.startChat({
          ...
          history: [
            ...
            {
              role: "user",
              parts: [{ text: "add Reverbian project" }],
            },
            {
              role: "model",
              parts: [
                {
                  text: "Here is more information about Bharath's projects:\n\n* **Reverbian:** A dynamic marketing agency website built using React.js, Tailwind CSS, Framer Motion, and a Rich Text Editor CMS. The site serves as a comprehensive digital platform for the agency, with service pages, client case studies, testimonials, and a dynamic blog section for content updates. [Visit Reverbian](https://reverbian.com/)\n",
                },
              ],
            },
            {
              role: "user",
              parts: [{ text: "add Nora AI project" }],
            },
            {
              role: "model",
              parts: [
                {
                  text: "Here's another one:\n\n* **Nora AI:** An AI chatbot developed as part of a team to seamlessly integrate into web platforms, enhancing user experience with intelligent real-time interactions. It offers businesses a powerful solution to automate customer support and improve user engagement.\n",
                },
              ],
            },
            {
              role: "user",
              parts: [{ text: "add Bateel project" }],
            },
            {
              role: "model",
              parts: [
                {
                  text: "And here's Bateel:\n\n* **Bateel:** An AI-driven chatbot interface inspired by ChatGPT, developed with React.js and TypeScript. The project integrates natural language processing (NLP) into a user-friendly interface for real-time conversations. It also features secure authentication for safe and efficient user interaction.\n",
                },
              ],
            },
            {
              role: "user",
              parts: [{ text: "add Fund Raiser Akron project" }],
            },
            {
              role: "model",
              parts: [
                {
                  text: "Finally, **Fund Raiser Akron:** A comprehensive web platform built with React.js, Node.js, Mongoose, and Nodemon. This platform connects business owners, startup founders, and investors, streamlining fundraising efforts with an easy-to-use interface for showcasing ideas and managing investor relations. [Visit Fund Raiser Akron](https://github.com/bharath-arch/akron.git)\n",
                },
              ],
            },
          ]
